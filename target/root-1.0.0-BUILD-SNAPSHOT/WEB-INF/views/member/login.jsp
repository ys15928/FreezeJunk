...
.login-input-box>input:last-child {
	margin-top: 10px;
}
...
<body
	style="width: 1920px; overflow-x: hidden; background-color: black;">

	<div style="">
		<div
			style="text-align: center; background-color: black; width: 563px; height: 301px; margin: auto; margin-top: 270px; border-radius: 20px;">
			<div style="height: 30px;"></div>
			<div class="login">
				<a href="${contextPath }/main"><img style="height: 60px;"
	...
	<script type="text/javascript">
		...
		function login() {
			if (document.getElementById("logId").value == ""
					|| document.getElementById("logId").value.replace(
							blank_pattern1, '') == "") {
				//	alert("아이디를 입력해 주세요.");
			...
			if (document.getElementById("logId").value.length > 12
					|| 4 > document.getElementById("logId").value.length) {
			...
			if (document.getElementById("logPwd").value.length > 16
					|| document.getElementById("logPwd").value.length < 8) {
